  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        launchPrice: 300000,
        bullets: ["Menu and pricing", "Table reservations", "WhatsApp ordering integration"],
      },
      {
    ...
    items: [
      {
        ...
        launchPrice: 230000,
        bullets: ["Up to 5 pages", "Mobile-responsive", "Contact form", "Basic on-page SEO"],
      },
      {
      ...
      },
      {
        ...
        launchPrice: 95000,
        bullets: ["Single-purpose page", "Fast turnaround", "Built to convert one action"],
      },
      {
        ...
        launchPrice: 290000,
        bullets: ["Property listings", "Search and filter", "Inquiry capture per listing"],
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        launchPrice: 210000,
        bullets: ["Design-only engagement", "For clients with their own developer"],
      },
      {
        ...
        launchPrice: 330000,
        bullets: ["Rebuild of an existing site", "Content and structure carried over"],
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        launchPrice: 85000,
        unit: "/month",
        bullets: ["Updates and small fixes", "Uptime monitoring"],
      },
      {
        name: "SEO",
        tier: "Starter",
        ...
        launchPrice: 90000,
        unit: "/month",
        bullets: ["Ongoing on-page work", "Local SEO", "Google Business Profile upkeep"],
      },
      {
        ...
        launchPrice: 60000,
        unit: "/year",
        bullets: ["Domain renewal", "Infrastructure oversight", "Monitoring"],
      },
      {
        name: "Branding",
        tier: "Starter",
        ...
        launchPrice: 120000,
        bullets: ["Logo", "Color system", "Basic brand guide"],
      },
    ],
  },
];
