...
export const AGREEMENT_SECTIONS: AgreementSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "7.5  Because the number of Referrer spots is capped and offered on a first-come, first-served basis, the Referrer is expected to bring in at least one (1) paying (Successful) referral per calendar month to retain their spot. Where a Referrer brings in no paying referral for a full calendar month, the Company may suspend that Referrer's account under this Agreement, and the vacated spot will be offered automatically to the next person on the Company's waitlist, in the order they joined it. A suspended Referrer may be reinstated at the Company's discretion, subject to a spot being available at that time.",
    ],
  },
  {
    number: "8",
